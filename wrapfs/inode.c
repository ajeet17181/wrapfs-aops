			 ...
			 int mode, struct nameidata *nd)
{
	...
	wrapfs_debug_iops(WRAPFS_SB(dir->i_sb)->wrapfs_debug_i_ops, "");
			 ...
			 struct inode *new_dir, struct dentry *new_dentry)
{
	...
	wrapfs_debug_iops(WRAPFS_SB(old_dir->i_sb)->wrapfs_debug_i_ops, "");
...
static int wrapfs_readlink(struct dentry *dentry, char __user *buf, int bufsiz)
{
	...
	wrapfs_debug_iops(WRAPFS_SB(dentry->d_sb)->wrapfs_debug_i_ops, "");
...
static int wrapfs_permission(struct inode *inode, int mask)
{
	...
	wrapfs_debug_iops(WRAPFS_SB(inode->i_sb)->wrapfs_debug_i_ops, "");
